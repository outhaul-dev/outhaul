...
func (s *Server) parseTemplates() error {
	...
	for _, p := range pages {
		...
		t, err := t.ParseFS(templatesFS, "templates/base.tmpl", "templates/appform.tmpl", "templates/hint.tmpl", "templates/copybtn.tmpl", "templates/domainform.tmpl", "templates/volumeform.tmpl", "templates/backups.tmpl", "templates/"+p+".tmpl")
		if err != nil {
			return err
		}
		s.pages[p] = t
...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("POST /apps/{id}/source", s.requireAuth(s.handleUpdateAppSource))
	...
	mux.HandleFunc("GET /deployments", s.handleDeploymentsRedirect)
	mux.HandleFunc("GET /containers", s.requireAuth(s.handleContainers))
